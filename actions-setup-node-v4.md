# `actions/setup-node@v4` — declared runtime evidence
...
| Resolved commit observed for `v4` | `49933ea5288caeca8642d1e84afbd3f7d6820020` |
...
https://github.com/actions/setup-node/blob/49933ea5288caeca8642d1e84afbd3f7d6820020/action.yml
...
This card does **not** claim that every workflow using setup-node v4 will fail, nor does it rate security or general compatibility. The major tag is mutable; this evidence is intentionally tied to the resolved commit above.
